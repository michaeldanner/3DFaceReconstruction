...
#################################################################################
# file paths
rendered_normal_images = r'D:/data/rendered_images/PERSP/Normals_CYCLES_None_XYZ/'
rendered_texture_images = r'D:/data/rendered_images/PERSP/Textures_EEVEE_LightingStrength4_sRGB_Standard/'
merged_images = r'D:/data/merged_images/PERSP_EEVEE_LightingStrength4_sRGB_Standard/'
